...
const QString BITCOIN_IPC_PREFIX("toppercash:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click toppercash: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start toppercash: click-to-pay handler");
    else
...
{
    // clicking on toppercash: URLs creates FileOpen events on the Mac:
